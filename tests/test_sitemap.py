...
async def test_sitemap(get_sitemap_links):
    ...
    get_sitemap_links += [
        'https://www.mozilla.org/2006/addons-blocklist', 'https://www.mozilla.org/ja/products/vpn/pricing/',
        'https://www.mozilla.org/en-US/MPL/2.0/differences/', 'https://www.mozilla.org/es-ES/products/vpn/pricing/'
    ]
